...
class PostDetailViewTests(APITestCase):
    def setUp(self):
        ...
        Post.objects.create(owner=adam, title='TITLE', content='Adams content')
        Post.objects.create(owner=brian, title='TITLE',
    ...
    def test_user_cannot_update_dont_own_post(self):
        self.client.login(username='adam', password='pass')
